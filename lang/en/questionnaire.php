...
$string['analysis_help'] = 'For detailed help on the Analysis feature, <b>right</b>-click <a href="lang/en/help_data_analysis.html"><b>HERE</b></a>';
$string['analysiserror01'] = 'Line {$a} must not be empty!';
$string['analysiserror02'] = 'Line {$a} must start with "$subscore =" (for subscore calculation) OR an "if ($subscore ...)" condition!';
$string['analysiserror03'] = 'ERROR Line {$a->linenumber} in your expression <strong>{$a->linestring}</strong> to calculate the subscore. Please read the Help.';
$string['analysiserror04'] = 'ERROR Line {$a->linenumber}: There is no {$a->questiontype}{$a->questionnb} in this Questionnaire!';
$string['analysiserror05'] = 'Unknown variable(s) <em>{$a->output}</em> in line {$a->linenumber}: <b>{$a->linestring}</b>.';
$string['analysiserror06'] = 'ERROR Line {$a->linenumber}: You should specify the {$a->questiontype} number in question {$a->questionnb} (out of {$a->nbsubquestions} {$a->subquestions}).';
$string['analysiserror07'] = 'ERROR Line {$a->linenumber} in your expression <strong>{$a->linestring}</strong> : Please check your "if ($totalcore ...)" condition!';
$string['analysiserror08'] = 'Missing $ sign in front of question(s) <strong>{$a->output}</strong> in line {$a->linenumber}: <b>{$a->linestring}</b>.';
$string['analysiserror09'] = 'ERROR Line {$a->linenumber} in your expression <strong>{$a->linestring}</strong> : Please check your "if ($subscore ...)" condition!';
...
$string['dependquestion'] = 'Depend Question';
$string['dependquestion_help'] = 'For detailed help on the Depend feature, <b>right</b>-click <a href="lang/en/help_skip_logic.html"><b>HERE</b></a>';
